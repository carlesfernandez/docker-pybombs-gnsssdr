...
RUN DEBIAN_FRONTEND=noninteractive apt-get -qq update && apt-get install --fix-missing -y --no-install-recommends \
  ...
  qt5-qmake=5.15.3+dfsg-2ubuntu0.1 \
  qtbase5-dev=5.15.3+dfsg-2ubuntu0.1 \
  qtbase5-dev-tools=5.15.3+dfsg-2ubuntu0.1 \
  swig=4.0.2-1ubuntu1 \
